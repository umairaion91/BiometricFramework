...
@interface MBBlinkCardUtils : NSObject
 ...
 */
+ (MBIssuer)determineIssuerFromCardNumberPrefix:(NSString *)cardNumberPrefix;
...
/**
 * Enum MBIssuer to string helper method
 */
+ (NSString *)issuerToString:(MBIssuer)issuer;
