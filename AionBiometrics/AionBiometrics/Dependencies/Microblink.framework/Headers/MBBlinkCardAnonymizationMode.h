 ...
 */
typedef NS_ENUM(NSInteger, MBBlinkCardAnonymizationMode) {

    /**
     * No anonymization is performed in this mode.
     */
    MBBlinkCardAnonymizationModeNone = 0,
     ...
     */
    MBBlinkCardAnonymizationModeImageOnly,

    /**
     * Document image is not changed. Data returned in result fields is redacted.
     */
    MBBlinkCardAnonymizationModeResultFieldsOnly,
     ...
     */
    MBBlinkCardAnonymizationModeFullResult
};
