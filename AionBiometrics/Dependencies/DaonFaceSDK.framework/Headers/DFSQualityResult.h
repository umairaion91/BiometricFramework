...
static NSString* const kQualityResultEyesFoundKey         = @"result.face.eyes.found";
static NSString* const kQualityResultEyesOpenKey          = @"result.face.eyes.open";
static NSString* const kQualityResultUniformLightingKey   = @"result.face.lighting";
static NSString* const kQualityResultEyeDistanceKey       = @"result.face.eyes.distance";
...
static NSString* const kQualityResultFaceCenteredKey      = @"result.face.centered";
...
static NSString* const kQualityResultEyesFoundScoreKey          = @"result.face.eyes.found.score";
static NSString* const kQualityResultEyesOpenScoreKey           = @"result.face.eyes.open.score";
static NSString* const kQualityResultEyeDistanceScoreKey        = @"result.face.eyes.distance.score";
...
/*!
 @brief Check if face is centered in the frame.
 */
@property (nonatomic, readonly) BOOL isFaceCentered;
